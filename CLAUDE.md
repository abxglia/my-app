...
```mermaid
graph TD
  016e1463["ERC-721 NFT"]
  99ebf0cf["Frontend"]
  d6152b57["Transaction History"]
  6824e04f["Wallet Auth"]
  f3f2cb18["Chain Data"]
  016e1463 --> 99ebf0cf
  99ebf0cf --> 6824e04f
  016e1463 --> d6152b57
...
1. **ERC-721 NFT** (`erc721-stylus`) — see `.nskills/components/erc721-stylus--016e1463.md`
2. **Frontend** (`frontend-scaffold`) — see `.nskills/components/frontend-scaffold--99ebf0cf.md`
3. **Transaction History** (`dune-transaction-history`) — see `.nskills/components/dune-transaction-history--d6152b57.md`
4. **Wallet Auth** (`wallet-auth`) — see `.nskills/components/wallet-auth--6824e04f.md`
5. **Chain Data** (`chain-data`) — see `.nskills/components/chain-data--f3f2cb18.md`
...
- [ERC-721 NFT](.nskills/components/erc721-stylus--016e1463.md)
- [Frontend](.nskills/components/frontend-scaffold--99ebf0cf.md)
- [Transaction History](.nskills/components/dune-transaction-history--d6152b57.md)
- [Wallet Auth](.nskills/components/wallet-auth--6824e04f.md)
- [Chain Data](.nskills/components/chain-data--f3f2cb18.md)
